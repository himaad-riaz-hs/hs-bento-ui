...
export const EDGE_CASE_SCENARIOS: EdgeCaseScenario[] = [
  ...
  {
    id: "edit-tag",
    title: "Edit tag — rename and regroup",
    description: "Edit an existing tag's name, colour, and group assignment from the 3-dot row menu.",
    watchFor: "Edit modal prefills current name and colour; group picker lets you move the tag; save updates the card inline.",
    manualAction: "Expand any group, hover a tag row, click ⋯ → Edit tag.",
    category: "creation",
    config: { dataPreset: "default", initialTab: "groups" },
  },
  {
    id: "import-tags",
    title: "Import tags via CSV",
    description: "Bulk-create or move tags into groups by uploading a CSV with tagName and groupName columns.",
    watchFor: "Import modal explains the format; success toast shows counts of new, moved, and unchanged tags.",
    manualAction: "Click the Import icon in the header toolbar.",
    category: "creation",
    config: { dataPreset: "default", initialTab: "groups" },
  },
  {
